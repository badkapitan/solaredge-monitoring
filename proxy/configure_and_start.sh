...
export TARGET_ORIGIN_HEADER=${TARGET_ORIGIN_HEADER:-http://${TARGET_HOST}:${TARGET_PORT}}
export TARGET_FORWARDED_HOST_HEADER=${TARGET_FORWARDED_HOST_HEADER:-\$host}
export CLIENT_MAX_BODY_SIZE=${CLIENT_MAX_BODY_SIZE:-20M}
export SSL_PORT=${SSL_PORT:-443}

REPLACEABLE='$SERVER_NAME:$TARGET_SCHEME:$TARGET_PORT:$TARGET_HOST:$TARGET_HOST_HEADER:$TARGET_ORIGIN_HEADER:$TARGET_FORWARDED_HOST_HEADER:$CLIENT_MAX_BODY_SIZE:$SSL_PORT'
